...
class RecentLinkListAdapter(
    private val mLinkArrayList: ArrayList<DashboardModel.Data.RecentLink>,
    private val isCallFromDashboard: Boolean,
    private val clipboardManager: ClipboardManager
) : RecyclerView.Adapter<RecentLinkListAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(private val binding: AdapterItemOpeninLinksBinding) :
        ...
        fun bind(linkArrayList: DashboardModel.Data.RecentLink, holder: MyViewHolder) {
